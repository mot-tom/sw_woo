...
PairStyle(sw/woo, PairSWWOO)

#else

#ifndef LMP_PAIR_SW_WOO_H
#define LMP_PAIR_SW_WOO_H
...
class PairSWWOO : public Pair {
 public:
  PairSWWOO(class LAMMPS *);
  virtual ~PairSWWOO();
